...
export default function HomeCleaning() {
  ...
  const prices = {
    Basic: { price: 10000, hours: "4 Hours", contract: "Month" },
    Standard: { price: 20000, hours: "6 Hours", contract: "Month" },
    Premium: { price: 35000, hours: "8 Hours", contract: "Month" },
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {(["Basic", "Standard", "Premium"] as const).map((item) => (
        ...
        >
          ...
          <Text style={styles.planDesc}>
            {item === "Basic" && "Essential cleaning for small homes"}
            {item === "Standard" && "Full home cleaning + deep scrubbing"}
            {item === "Premium" && "Complete sanitization + premium care"}
          </Text>
      ...
      <TouchableOpacity style={styles.button} onPress={handleBook}>
        <Text style={styles.btnText}>Book Home Cleaning</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
